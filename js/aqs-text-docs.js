    ...
    function callAI(prompt) {
        ...
        function groqReq(model) {
          return fetch('https://api.groq.com/openai/v1/chat/completions', {
            ...
            body:JSON.stringify({model:model,messages:[{role:'user',content:prompt}],max_tokens:2000,temperature:0.3})
          }).then(function(r){
        ...
        if (groqKey) {
          return groqReq('llama-3.1-8b-instant')
            .catch(function(e){
              if (e.message==='RATE_LIMIT') return groqReq('llama3-8b-8192');
              throw e;
            })
