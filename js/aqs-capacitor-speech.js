...
(function () {
  ...
  bottomNavStyle.textContent =
    ...
    '.aqs-bottom-nav{position:fixed;left:0;right:0;bottom:0;height:calc(var(--aqs-bottom-nav-h) + env(safe-area-inset-bottom,0px));' +
      ...
      'box-shadow:0 -8px 24px rgba(0,0,0,.28);backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px);z-index:10000;}' +
    ...
    'body.aqs-has-bottom-nav{padding-bottom:var(--aqs-bottom-nav-h)!important;}' +
    '@media(min-width:769px){.aqs-bottom-nav{display:none!important;}body.aqs-has-bottom-nav{padding-bottom:0!important;}}' +
    '@media(max-width:768px){#dts-footer{bottom:calc(var(--aqs-bottom-nav-h) + env(safe-area-inset-bottom,0px))!important;}' +
      '#dts-main{padding-bottom:calc(var(--dts-footer-h,80px) + var(--aqs-bottom-nav-h) + env(safe-area-inset-bottom,0px))!important;}' +
      '#dts-messages{padding-bottom:calc(100px + var(--aqs-bottom-nav-h) + env(safe-area-inset-bottom,0px))!important;}}';
