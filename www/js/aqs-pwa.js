...
(function () {
    ...
    /* ── Service Worker registration — enables offline support & PWA install ── */
    if ('serviceWorker' in navigator && !window.Capacitor) {
        /* Only register SW in browser context — Capacitor native app handles assets natively */
        window.addEventListener('load', function () {
            navigator.serviceWorker.register('aqs-sw.js', { scope: './' })
                .then(function (reg) {
