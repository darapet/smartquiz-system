...
**How to apply:** Keep native audio focus, microphone unmute, communication mode, and speaker routing in the Android bridge. Reapply the route after capture starts, bind remote playback to the WebRTC event stream when available, and validate on two physical Android devices.